...
'''
This fib above is very inneficient if you have to walk through a thousand numbers . . so NOTE: in the nest section (DICTIONARIES) we 
shall use DICTIONARIES to make it more efficient.
